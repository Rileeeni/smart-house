...
from .views import Me,AlarmList,ScenariosList,ScenariosAdd,RoomAdd,RoomNameDeviceByName,RoomAddDevice,ScenariosById,ListRoom,DeviceList,RoomTelemetry
urlpatterns = [
   ...
   #  path('/api/v1/auth/regis'),
    ...
    path("api/v1/me/room/devices",DeviceList.as_view(),name='device_list'),
    path('api/v1/me/room/<str:name>/devices/<str:device_name>/', RoomNameDeviceByName.as_view(), name='room-device-detail'),
